...
{
    die("Erro: Imagem modelo de certificado não cadastrada! Entre em contato com a plataforma para solucionar o problema.");
}
...
$subscription = (new Subscription([ 'id' => $subsId, 'student_id' => $_SESSION['user_id'] ]))->getSingleFromStudent($conn);
